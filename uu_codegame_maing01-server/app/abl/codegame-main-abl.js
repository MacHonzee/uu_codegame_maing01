...
const Errors = require("../api/errors/codegame-main-error.js");
...
const logger = LoggerFactory.get("CodegameMainAbl");

class CodegameMainAbl {
  constructor() {
...
module.exports = new CodegameMainAbl();
